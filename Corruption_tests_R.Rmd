...
```{r warning=FALSE}
# This data is from the The World Bank
Corruption_Data3 <- read.csv("model3_R_input.csv")
Corruption_Data4 <- read.csv("model4_R_input.csv")
Corruption_Data3 <- Corruption_Data3[1:616,]
Corruption_Data4 <- Corruption_Data4[1:616,]
```


```{r}
FDII$CC_EST <- Corruption_Data3$CC_EST_AVERAGE
FDII$CPI_EST <- Corruption_Data4$CPI_EST_AVERAGE

FDII$CC_EST_SUM <- Corruption_Data3$CC_EST_SUM
FDII$CPI_EST_SUM <- Corruption_Data4$CPI_EST_SUM

FDII$CC_EST_RANK <- Corruption_Data3$CC_EST_AVERAGE_RANK
FDII$CPI_EST_RANK <- Corruption_Data4$CPI_EST_AVERAGE_RANK

FDII$CC_EST_RANK_SUM <- Corruption_Data3$CC_EST_RANK_SUM
FDII$CPI_EST_RANK_SUM <- Corruption_Data4$CPI_EST_RANK_SUM

FDII$CC_EST_COUNT <- Corruption_Data3$CC_EST_COUNT
FDII$CPI_EST_COUNT <- Corruption_Data4$CPI_EST_COUNT
```
...
FDII$MP_dev_sum <- MP_df$GDPPC_SUM
...
```{r}
ggplot(data = FDII, aes(x = MP_dev_avg, y = CC_EST)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "gam", formula = y ~ s(x, bs = "cs"), color = "deepskyblue4") +
  labs(x = "Developed Average", 
       y = "World Bank Corruption Estimate") +
  theme_minimal()
```
```{r}
ggplot(data = FDII, aes(x = MP_dev_avg, y = CC_EST_RANK)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "gam", formula = y ~ s(x, bs = "cs"), color = "deepskyblue4") +
  labs(x = "Developed Average", 
       y = "World Bank Corruption Estimate") +
...
```{r}
ggplot(data = FDII, aes(x = MP_dev_avg, y = CPI_EST)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "gam", formula = y ~ s(x, bs = "cs"), color = "deepskyblue4") +
  labs(x = "Developed Average", 
       y = "CPI Corruption Estimate") +
  theme_minimal()
```

```{r}
ggplot(data = FDII, aes(x = MP_dev_avg, y = CPI_EST_RANK)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "gam", formula = y ~ s(x, bs = "cs"), color = "deepskyblue4") +
  labs(x = "Developed Average", 
       y = "CPI Corruption Estimate") +
...
```{r}
WB_pub <- ggplot(data = FDII, aes(x = CC_EST, y = developed_average)) +
  geom_point(color = "lightblue3", size = 1) +
  geom_smooth(method = "lm", color = "deepskyblue4") +
  ylim(1, 4) +
  labs(x = "Corruption Estimate", 
       y = "Average Country Development\n(World Bank categorsation)") + 
  theme_minimal()

MP_pub <- ggplot(data = FDII, aes(x = CC_EST, y = MP_dev_avg)) +
  geom_point(color = "lightblue3", size = 1) +
  geom_smooth(method = "lm", color = "deepskyblue4") +
  ylim(1, 4) +
  labs(x = "Corruption Estimate", 
...
```{r}
WB_pub <- ggplot(data = FDII, aes(x = CPI_EST, y = developed_average)) +
  geom_point(color = "lightblue3", size = 1) +
  geom_smooth(method = "lm", color = "deepskyblue4") +
  ylim(1, 4) +
  labs(x = "CPI Corruption Estimate", 
       y = "Average Country Development\n(World Bank categorsation)") + 
  theme_minimal()

MP_pub <- ggplot(data = FDII, aes(x = CPI_EST, y = MP_dev_avg)) +
  geom_point(color = "lightblue3", size = 1) +
  geom_smooth(method = "lm", color = "deepskyblue4") +
  ylim(1, 4) +
  labs(x = "CPI Corruption Estimate", 
...
```{r}
ggplot(data = FDII, aes(x = CC_EST, y = PCC)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "loess", color = "deepskyblue4") +
  labs(x = "WGI Corruption Estimate", 
       y = "Partial Correlation Coefficient") + 
  theme_minimal()
```

```{r}
ggplot(data = FDII, aes(x = CC_EST_RANK, y = PCC)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "loess", color = "deepskyblue4") +
  labs(x = "WGI Corruption Estimate", 
       y = "Partial Correlation Coefficient") + 
...
```{r}
ggplot(data = FDII, aes(x = CPI_EST, y = PCC)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "loess", color = "deepskyblue4") +
  labs(x = "CPI Corruption Estimate", 
       y = "Partial Correlation Coefficient") + 
...
```{r}
ggplot(data = FDII, aes(x = CPI_EST_RANK, y = PCC)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "loess", color = "deepskyblue4") +
  labs(x = "CPI Corruption Estimate", 
       y = "Partial Correlation Coefficient") + 
...
```{r}
ggplot(data = FDII, aes(x = publication_time, y = CC_EST)) +
  geom_point(color = "lightblue3", size = 1) +
  geom_smooth(method = "lm", color = "deepskyblue4") +
  labs(x = "Publication Year", 
...
corruption_trend <- read.csv("df_model3.csv")
```



```{r}
maddison_df$LogCC_EST <- log(maddison_df$GDP.per.capita)
...
ggplot(data = maddison_df_recent, aes(x = Year, y = LogCC_EST, color = Code)) +
  geom_point(size = 1) +
...
```{r}
unique_codes <- unique(corruption_trend$iso3c)
grey_blue_colors <- colorRampPalette(c("lightgrey", "lightblue3"))(length(unique_codes))
color_mapping <- setNames(grey_blue_colors, unique_codes)

ggplot(data = corruption_trend, aes(x = year, y = CC_EST, color = iso3c)) +
  geom_point(size = 1) +
  geom_smooth(method = "gam", se = FALSE, color = "deepskyblue4") +
  ylim(0,100) +
  labs(x = "Year", 
       y = "WGI Corruption Estimate") +
  scale_color_manual(values = color_mapping, breaks = NULL) +
  theme_minimal() +
  geom_vline(xintercept = 2012, linetype = "dashed", color = "#008B68")
...
```{r}
# Create a copy of FDII for manipulation
FDII_copy <- FDII

# Add lagged variables and moving average with reduced parameters
FDII_copy <- FDII_copy %>%
  mutate(
    time_lag = publication_time - sample_period_end,
    PCC_adj = abs(PCC) - PCC_se,
    time_lag_1 = lag(time_lag, 1),  # Reduced to 1 period lag
    # Using rollapply with a smaller window and partial = TRUE
    moving_avg_time_lag = rollapply(time_lag, width = 2, FUN = mean, partial = TRUE, align = 'right', fill = NA)
  )

# Remove NAs selectively for the regression model variables
FDII_copy <- FDII_copy %>%
  filter(!is.na(time_lag) & !is.na(PCC_adj) & !is.na(time_lag_1) & !is.na(moving_avg_time_lag))

# Check how many rows remain
print(paste("Rows after selective NA removal in copy:", nrow(FDII_copy)))

# Proceed with the regression model if there are enough rows
if(nrow(FDII_copy) > 0) {
  model <- lm(PCC_adj ~ time_lag + time_lag_1 + moving_avg_time_lag, data = FDII_copy)
  summary(model)
} else {
  print("Not enough data after selective NA removal to fit the model in the copy.")
}
```

```{r}
# Calculate the time lag between study end and publication
FDII$time_lag <- FDII$publication_time - FDII$sample_period_end

# Calculate the absolute value of PCC minus its SE
FDII$PCC_adj <- abs(FDII$PCC) - FDII$PCC_se

# Fit the linear regression model
time_lag_model <- lm(PCC_adj ~ time_lag, data = FDII)

# Summary of the model to check the coefficients and statistical significance
...
# Control(s)
FDII$GDP_control <- ifelse(FDII$control_variables_1 %in% c('CC_EST', 'GDP', 'CC_EST^2','GDP^2') | FDII$control_variables_2 %in% c('CC_EST', 'GDP', 'CC_EST^2','GDP^2') | FDII$control_variables_3 %in% c('CC_EST', 'GDP', 'CC_EST^2','GDP^2') | FDII$control_variables_4 %in% c('CC_EST', 'GDP', 'CC_EST^2','GDP^2') | FDII$control_variables_5 %in% c('CC_EST', 'GDP', 'CC_EST^2','GDP^2'), 1, 0)
...
```{r}
funnel_data <- metafor::funnel(m.higher,
                      title = "FDI Impacts on Income Inequality",
                      xlim = c(-1, 1),
                      ylim = rev(c(45, 0)),
                      studlab = FALSE,
                      ...
                      bg = "lightblue3",
                      cex = 0.6)
eggers.test(m.higher)
```

```{r}
funnel_data <- metafor::funnel(m.middle,
                      title = "FDI Impacts on Income Inequality",
                      xlim = c(-1, 1),
                      ylim = rev(c(45, 0)),
                      studlab = FALSE,
                      ...
                      bg = "lightblue3",
                      cex = 0.6)
eggers.test(m.middle)
```

```{r}
funnel_data <- metafor::funnel(m.lower,
                      title = "FDI Impacts on Income Inequality",
                      xlim = c(-1, 1),
                      ylim = rev(c(45, 0)),
                      studlab = FALSE,
...
ggplot(data = FDII, aes(x = PCC, y = 1/PCC_se)) +
  geom_point(color = "lightblue3", size = 1) +
  geom_vline(aes(xintercept = mean(PCC_se)), linetype = "dashed", color = "deepskyblue4") +
  ylim(0, 45) +
...
```{r}
meta.anal.full.model.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + median_log_GDPPC + CC_EST + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.cc
```
...
meta.anal.full.model.cc <- rma(yi = PCC,
                            ...
                            data = FDII,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + mean_log_GDPPC+ est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CC_EST,
                            test = "knha",
                            digits = 3)
...
```{r}
meta.anal.full.model.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + mean_log_GDPPC+ est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.cpi
```

```{r}
meta.anal.full.model.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + mean_log_GDPPC+ est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.cc.rank
```

```{r}
meta.anal.full.model.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + mean_log_GDPPC+ est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.cpi.rank
```
...
```{r}
meta.anal.select.model.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ median_log_GDPPC + CC_EST + median_log_GDPPC*CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.cc
```
...
meta.anal.select.model.cc <- rma(yi = PCC,
                            ...
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + CC_EST + single_country + if_published + PCC_se,
                            test = "knha",
                            digits = 3)
...
meta.anal.select.model.cc <- rma(yi = PCC,
                            ...
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + mean_log_GDPPC + single_country + if_published + PCC_se + CC_EST,
                            test = "knha",
                            digits = 3)
...
```{r}
meta.anal.select.model.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + mean_log_GDPPC + single_country + if_published + PCC_se + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.cpi
```

```{r}
meta.anal.select.model.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + mean_log_GDPPC + single_country + if_published + PCC_se + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.cc.rank
```

```{r}
meta.anal.select.model.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + mean_log_GDPPC + single_country + if_published + PCC_se + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.cpi.rank
```
...
```{r}
meta.anal.select.model.median.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + single_country + if_published + PCC_se + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.median.cc
```


```{r}

meta.anal.select.model.median.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + single_country + if_published + PCC_se + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.median.cpi
```

```{r}
meta.anal.select.model.median.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + single_country + if_published + PCC_se + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.median.cc.rank
```


```{r}

meta.anal.select.model.median.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + single_country + if_published + PCC_se + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.median.cpi.rank
```
...
```{r}
meta.anal.select.model.nopub.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + single_country + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.nopub.cc
```

```{r}
meta.anal.select.model.nopub.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + single_country + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.nopub.cpi
```

```{r}
meta.anal.select.model.nopub.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + single_country + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.nopub.cc.rank
```

```{r}
meta.anal.select.model.nopub.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + single_country + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.nopub.cpi.rank
```
...
```{r}
meta.anal.full.model.noend.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.noend.cc
```

```{r}
meta.anal.full.model.noend.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.noend.cpi
```

```{r}
meta.anal.full.model.noend.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.noend.cc.rank
```

```{r}
meta.anal.full.model.noend.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ GINI_control + I_Share + W_I_Disp + median_log_GDPPC + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.noend.cpi.rank
```
...
```{r}
meta.anal.full.model.noin.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ median_log_GDPPC + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.noin.cc
```

```{r}
meta.anal.full.model.noin.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ median_log_GDPPC + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.noin.cpi
```

```{r}
meta.anal.full.model.noin.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ median_log_GDPPC + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.noin.cc.rank
```

```{r}
meta.anal.full.model.noin.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ median_log_GDPPC + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.noin.cpi.rank
```

### Drop the GDP controls

```{r}
meta.anal.full.model.only.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ CC_EST,
...
meta.anal.full.model.only.cc
```


```{r}
meta.anal.full.model.only.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ CPI_EST,
...
meta.anal.full.model.only.cpi
```

```{r}
meta.anal.full.model.only.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ CC_EST_RANK,
...
meta.anal.full.model.only.cc.rank
```


```{r}
meta.anal.full.model.only.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII,
                            method = "REML",
                            mods = ~ CPI_EST_RANK,
...
meta.anal.full.model.only.cpi.rank
```
...
```{r}
meta.anal.full.model.higher.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.higher.cc
```

```{r}
meta.anal.full.model.higher.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.higher.cpi
```
```{r}
meta.anal.full.model.higher.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.higher.cc.rank
```

```{r}
meta.anal.full.model.higher.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.full.model.higher.cpi.rank
```
...
```{r}
meta.anal.select.model.higher.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ stock + W_I_Disp + GDP_control + education_control + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.higher.cc
```

```{r}
meta.anal.select.model.higher.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ stock + W_I_Disp + GDP_control + education_control + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.higher.cpi
```

```{r}
meta.anal.select.model.higher.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ stock + W_I_Disp + GDP_control + education_control + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.higher.cc.rank
```

```{r}
meta.anal.select.model.higher.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ stock + W_I_Disp + GDP_control + education_control + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.higher.cpi.rank
```
...
```{r}
meta.anal.full.model.middle.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CC_EST,
...
meta.anal.full.model.middle.cc
```

```{r}
meta.anal.full.model.middle.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CPI_EST,
...
meta.anal.full.model.middle.cpi
```

```{r}
meta.anal.full.model.middle.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CC_EST_RANK,
...
meta.anal.full.model.middle.cc.rank
```

```{r}
meta.anal.full.model.middle.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CPI_EST_RANK,
...
meta.anal.full.model.middle.cpi.rank
```
...
```{r}
meta.anal.select.model.middle.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ stock + I_Share + est_method + GDP_control + education_control + single_country + if_published + PCC_se + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.middle.cc
```

```{r}
meta.anal.select.model.middle.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ stock + I_Share + est_method + GDP_control + education_control + single_country + if_published + PCC_se + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.middle.cpi
```

```{r}
meta.anal.select.model.middle.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ stock + I_Share + est_method + GDP_control + education_control + single_country + if_published + PCC_se + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.middle.cc.rank
```

```{r}
meta.anal.select.model.middle.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ stock + I_Share + est_method + GDP_control + education_control + single_country + if_published + PCC_se + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.middle.cpi.rank
```
...
```{r}
meta.anal.test.model.middle.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ est_method + GDP_control + education_control + gov_inequality_effort_control + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.test.model.middle.cc
```

```{r}
meta.anal.test.model.middle.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ est_method + GDP_control + education_control + gov_inequality_effort_control + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.test.model.middle.cpi
```

```{r}
meta.anal.test.model.middle.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ est_method + GDP_control + education_control + gov_inequality_effort_control + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.test.model.middle.cc.rank
```

```{r}
meta.anal.test.model.middle.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ est_method + GDP_control + education_control + gov_inequality_effort_control + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.test.model.middle.cpi.rank
```
...
```{r}
meta.anal.full.model.lower.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CC_EST,
...
meta.anal.full.model.lower.cc
```

```{r}
meta.anal.full.model.lower.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CPI_EST,
...
meta.anal.full.model.lower.cpi
```

```{r}
meta.anal.full.model.lower.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CC_EST_RANK,
...
meta.anal.full.model.lower.cc.rank
```

```{r}
meta.anal.full.model.lower.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ stock + GINI_control + I_Share + W_I_Disp + est_method + GDP_control + education_control + single_country + trade_control + population_control + inflation_control + unemployment_control + gov_inequality_effort_control + if_published + PCC_se + CPI_EST_RANK,
...
meta.anal.full.model.lower.cpi.rank
```
...
```{r}
meta.anal.select.model.lower.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ GDP_control + single_country + population_control + inflation_control + unemployment_control + PCC_se + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.lower.cc
```

```{r}
meta.anal.select.model.lower.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ GDP_control + single_country + population_control + inflation_control + unemployment_control + PCC_se + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.lower.cpi
```

```{r}
meta.anal.select.model.lower.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ GDP_control + single_country + population_control + inflation_control + unemployment_control + PCC_se + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.lower.cc.rank
```

```{r}
meta.anal.select.model.lower.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ GDP_control + single_country + population_control + inflation_control + unemployment_control + PCC_se + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.select.model.lower.cpi.rank
```
...
```{r}
meta.anal.test.model.lower.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ GDP_control + single_country + population_control + inflation_control + unemployment_control + CC_EST,
                            test = "knha",
                            digits = 3)

meta.anal.test.model.lower.cc
```

```{r}
meta.anal.test.model.lower.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ GDP_control + single_country + population_control + inflation_control + unemployment_control + CPI_EST,
                            test = "knha",
                            digits = 3)

meta.anal.test.model.lower.cpi
```

```{r}
meta.anal.test.model.lower.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ GDP_control + single_country + population_control + inflation_control + unemployment_control + CC_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.test.model.lower.cc.rank
```

```{r}
meta.anal.test.model.lower.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ GDP_control + single_country + population_control + inflation_control + unemployment_control + CPI_EST_RANK,
                            test = "knha",
                            digits = 3)

meta.anal.test.model.lower.cpi.rank
```



## Only corruption estimates for different income levels

### Higher Income

```{r}
meta.anal.test.model.higher.only.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ CC_EST,
...
meta.anal.test.model.higher.only.cc
```

```{r}
meta.anal.test.model.higher.only.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ CPI_EST,
...
meta.anal.test.model.higher.only.cpi
```

```{r}
meta.anal.test.model.higher.only.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ CC_EST_RANK,
...
meta.anal.test.model.higher.only.cc.rank
```

```{r}
meta.anal.test.model.higher.only.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_higher,
                            method = "REML",
                            mods = ~ CPI_EST_RANK,
...
meta.anal.test.model.higher.only.cpi.rank
```
...
```{r}
meta.anal.test.model.middle.only.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ CC_EST,
...
meta.anal.test.model.middle.only.cc
```

```{r}
meta.anal.test.model.middle.only.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ CPI_EST,
...
meta.anal.test.model.middle.only.cpi
```

```{r}
meta.anal.test.model.middle.only.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ CC_EST_RANK,
...
meta.anal.test.model.middle.only.cc.rank
```

```{r}
meta.anal.test.model.middle.only.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_middle,
                            method = "REML",
                            mods = ~ CPI_EST_RANK,
...
meta.anal.test.model.middle.only.cpi.rank
```
...
```{r}
meta.anal.test.model.lower.only.cc <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ CC_EST,
...
meta.anal.test.model.lower.only.cc
```

```{r}
meta.anal.test.model.lower.only.cpi <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ CPI_EST,
...
meta.anal.test.model.lower.only.cpi
```

```{r}
meta.anal.test.model.lower.only.cc.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ CC_EST_RANK,
...
meta.anal.test.model.lower.only.cc.rank
```

```{r}
meta.anal.test.model.lower.only.cpi.rank <- rma(yi = PCC,
                            sei = PCC_se,
                            data = FDII_lower,
                            method = "REML",
                            mods = ~ CPI_EST_RANK,
...
meta.anal.test.model.lower.only.cpi.rank
```
...
ggplot(FDII, aes(x = publication_time, y = PCC)) +
  geom_point(size = 1, color = "lightblue3") +
  geom_smooth(method = "loess", col = "DeepSkyBlue4") +
